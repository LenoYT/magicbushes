...
public class EtherealSaplingBlock extends BushBlock implements BonemealableBlock {
    ...
    public EtherealSaplingBlock(BlockBehaviour.Properties p_152067_) {
        super(p_152067_);
    }
    ...
    protected boolean mayPlaceOn(BlockState blockState, BlockGetter blockGetter, BlockPos blockPos) {
        return blockGetter.getBlockState(blockPos).is(ModBlocks.ETHEREAL_MOSS);
    }
    ...
    public void performBonemeal(ServerLevel p_220707_, RandomSource p_220708_, BlockPos p_220709_, BlockState p_220710_) {
        TreeGrower.DARK_OAK.growTree(p_220707_, p_220707_.getChunkSource().getGenerator(), p_220709_, p_220710_, p_220708_);
    }
}
